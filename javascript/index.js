...
/*async function getInstruction() {
  try {
    const step0 = await (getInstruction('mashedPotatoes', 0));
  document.querySelector("#mashedPotatoes").innerHTML += `<li>${step0}</li>`;
    ...
    console.log(`Number of users: ${responseOne.data.length}`);
    console.log(`Number of albums: ${responseTwo.data.length}`);
  } catch (e) {
